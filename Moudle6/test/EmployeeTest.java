...
//import organization.util.Gender;
//import util.Organization;
//import organization.organization.OrganizationImpl;
...
public class EmployeeTest {
  ...
  public void testGetSize() {
    Assert.assertEquals(13,ccis.getSize());
    Assert.assertEquals(6,ccis.getSizeByGender(Gender.Female));
    Assert.assertEquals(7,ccis.getSizeByGender(Gender.Male));

    Assert.assertEquals(8,startup.getSize());
    Assert.assertEquals(1,startup.getSizeByGender(Gender.Female));
    Assert.assertEquals(5,startup.getSizeByGender(Gender.Male));
    Assert.assertEquals(2,startup.getSizeByGender(Gender.UnDisclosed));
  }
  ...
  public void testAllEmployees() {
    ...
    Assert.assertEquals(expected,actualResult.toString());
  ...
  public void testEmployeePay() {
    Assert.assertEquals(5,ccis.countPayAbove(150000));
    Assert.assertEquals(1,ccis.countPayAbove(300000));
  }
  ...
  public void testTerminatedBy() {
    ...
    Assert.assertEquals(1,startup.terminatedBefore(2,9,2018));
    Assert.assertEquals(2,startup.terminatedBefore(16,9,2018));
    Assert.assertEquals(3,startup.terminatedBefore(31,10,2018));
    Assert.assertEquals(4,startup.terminatedBefore(31,12,2018));
  }
}